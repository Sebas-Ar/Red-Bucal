    ...
    return (
        <div className="content">
            ...
            <style jsx>{`
                ...
                h3:nth-child(1) {
                    background-color: ${type ? 'rgb(140, 184, 209, .5)' : 'var(--puntoAzul)'};
                }

                h3:nth-child(3) {
                    background-color: ${type ? 'var(--puntoRojo)' : '#D97C6E77'};
                }
                ...
                i{
                    background-color: ${type ? 'var(--puntoRojo)' : 'var(--puntoAzul)'};
                    border: none;
                    position: absolute; 
                    left: 0;
                    top: 0;
                ...
                i:before{
                    ...
                    left: 5px;
                    top: 50%;
                    transform: translateY(-50%) ${type ? 'translateX(54px)' : 'translateX(0px)'};
